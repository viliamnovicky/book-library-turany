...
exports.showAllSearchFields = exports.resetSearchedData = exports.openDialog = exports.hideAllSearchFields = exports.getFilterValues = void 0;
          ...
          if (res.data.status === 'success') {
            ...
            if (statsCont) {
              statsCont.addEventListener("click", function (e) {
                ...
                var btnDetails = e.target.closest(".btn");
