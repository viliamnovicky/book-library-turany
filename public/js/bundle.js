...
var displayMap = function displayMap() {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmlsaWFtbm92aWNreSIsImEiOiJjbGYwMThxenIwNHJpM3F0NTBmbHhiNmg2In0.tUwpY9_7AGy6jElppCtbKA';
...
},{}],"headerLinksController.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.headerLinkController = void 0;
var headerLinkController = function headerLinkController() {
  var links = document.querySelectorAll(".nav__el");
  var location = window.location.href.split("/").at(-1);
  console.log(location);
  links.forEach(function (link) {
    return link.id === location ? link.classList.add("nav__el--active") : link.classList.remove("nav__el--active");
  });
};
exports.headerLinkController = headerLinkController;
...
},{}],"authorisation.js":[function(require,module,exports) {
"use strict";
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            window.setTimeout(function () {
              res.data.data.user.role === 'user' ? location.reload() : location.assign('/nova-kniha');
            }, 500);
          }
          _context.next = 10;
          break;
...
exports.showAllSearchFields = exports.resetSearchedData = exports.openDialogI = exports.openDialog = exports.hideModal = exports.hideAllSearchFields = exports.getFilterValues = void 0;
var showAllSearchFields = function showAllSearchFields() {
  document.querySelectorAll('#manual-search').forEach(function (el) {
    return el.classList.remove('hidden');
  });
  document.querySelector('.no-success').classList.add('hidden');
};
exports.showAllSearchFields = showAllSearchFields;
var hideAllSearchFields = function hideAllSearchFields() {
  document.querySelectorAll('#manual-search').forEach(function (el) {
...
exports.hideAllSearchFields = hideAllSearchFields;
var resetSearchedData = function resetSearchedData() {
  var options = document.querySelectorAll('.option');
  options.forEach(function (option) {
    return option.remove();
  });
};
exports.resetSearchedData = resetSearchedData;
var openDialog = function openDialog() {
  document.getElementById('uploadPhoto').click();
};
exports.openDialog = openDialog;
var openDialogI = function openDialogI() {
  document.getElementById('uploadAvatar').click();
};
exports.openDialogI = openDialogI;
var getFilterValues = function getFilterValues() {
  var author = document.getElementById("database-author").value;
  var name = document.getElementById("database-name").value;
  var filter = document.querySelector(".sort__active").id;
...
var hideModal = function hideModal() {
  ...
  var btnCloseModal = document.querySelector(".btn__close-modal");
...
},{}],"searchBook.js":[function(require,module,exports) {
"use strict";
...
var searchBook = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(authorName, titleName) {
    var res, bookPreview, data, modal, modalInner, author, name, year, isbn, searchBookCoverBtn, btnCloseModal, authors, names, years, isbns, images;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "https://www.googleapis.com/books/v1/volumes?q=".concat(titleName.split(' ').join('+'), "+inauthor:").concat(authorName.split(' ').join('+'))
          });
        case 3:
          res = _context.sent;
          bookPreview = document.querySelector('.img__book-preview');
          data = res.data.items;
          ...
          if (data) {
            ...
            searchBookCoverBtn = document.querySelector('.btn__search-img');
            ...
            years = [];
            data.map(function (book) {
              if (book.volumeInfo.publishedDate) years.push(book.volumeInfo.publishedDate.slice(0, 4));
            });
            if (years.length > 0) years.map(function (y) {
              year.insertAdjacentHTML('beforeend', "<option class=\"option\" value=\"".concat(y, "\">").concat(y, "</option>"));
            });
            isbns = [];
            data.map(function (book) {
              if (book.volumeInfo.industryIdentifiers) book.volumeInfo.industryIdentifiers.map(function (isbn) {
                if (isbn.identifier.length > 10) isbns.push(isbn.identifier);
              });
            });
            if (isbns.length > 0) isbns.map(function (isbnNum) {
              isbn.insertAdjacentHTML('beforeend', "<option class=\"option\" value=\"".concat(isbnNum, "\">").concat(isbnNum, "</option>"));
            });
            console.log(isbns);
            images = [];
            data.map(function (book) {
              if (book.volumeInfo.imageLinks) images.push(book.volumeInfo.imageLinks.thumbnail);
            });
            if (images.length > 1) images.map(function (image) {
              return modalInner.insertAdjacentHTML('beforeend', "<img class=\"img__books-results option\" src=\"".concat(image, "\" alt=\"book\">"));
            });
            ...
            modalInner.addEventListener('click', function (e) {
              var img = e.target.closest('.img__books-results');
            ...
            (0, _helpers.showAllSearchFields)();
            document.querySelector('.form__label--info').textContent = 'Našla sa zhoda, skontrolujte a poprípade upravte údaje.';
            console.log(data);
          } else {
            document.querySelector('.form__label--info').textContent = 'Nepodarilo sa nájsť žiadne výsledky, skúste to znova';
            document.querySelector('.no-success').classList.remove('hidden');
            (0, _helpers.hideAllSearchFields)();
          }
          _context.next = 13;
          break;
        case 10:
...
},{"axios":"../../node_modules/axios/index.js","./helpers":"helpers.js"}],"createBook.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') (0, _alerts.showAlert)('success', 'Kniha úspešne pridaná do databázy', 5);
          window.setTimeout(function () {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', 'Kniha už je v databáze', 5);
        case 11:
        case "end":
          return _context.stop();
      }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"models/userModel.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.loadUserStats = void 0;
var loadUserStats = function loadUserStats(data) {
  var modal = document.querySelector('.modal');
  var modalInner = document.querySelector('.modal__inner');
  data.map(function (book) {
    modalInner.insertAdjacentHTML('beforeend', "<div class=\"flip-card\">\n        <div class=\"flip-card__inner\">\n          <div class=\"flip-card__front\">\n            <img class=\"flip-card__img\" src=\"".concat(book.book.coverImage.startsWith('http') ? book.book.coverImage : '/img/books/' + book.book.coverImage, "\" alt=\"book ").concat(book.book.name, " ").concat(book.book.author, "\">\n          </div>\n          <div class=\"flip-card__back\">\n            <h4><span>Dielo:</span> ").concat(book.book.name, "</h4>\n            <h4><span>Autor:</span> ").concat(book.book.author, "</h4>\n            <h4><span>Pridan\xE9:</span> ").concat(new Date(book.wasAdded).getDay() + 1, ".").concat(new Date(book.wasAdded).getMonth() + 1, ".").concat(new Date(book.wasAdded).getFullYear(), "</h4>\n            <h4><span>D\xE1tum vydania:</span> ").concat(new Date(book.book.releaseDate).getDay() + 1, ".").concat(new Date(book.book.releaseDate).getMonth() + 1, ".").concat(new Date(book.book.releaseDate).getFullYear(), "</h4>\n            <h4><span>ISBN:</span> ").concat(book.book.ISBN, "</h4>\n          </div>\n        </div>\n      </div>"));
  });
};
exports.loadUserStats = loadUserStats;
},{}],"getCurrentUserData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getCurrentUserData = void 0;
var _axios = _interopRequireDefault(require("axios"));
...
var getCurrentUserData = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            user = res.data.data;
            statsCont = document.querySelector(".profile__content");
            if (statsCont) {
              statsCont.addEventListener("click", function (e) {
                ...
                var modalInner = document.querySelector(".modal__inner");
                var btnCloseModal = document.querySelector(".btn__close-modal");
                var btnDetails = e.target.closest(".btn__show-stat");
                modalInner.textContent = "";
                if (btnDetails) {
                  if (btnDetails.id === "booksRead") (0, _userModel.loadUserStats)(user.read);
                  if (btnDetails.id === "booksBorrowed") (0, _userModel.loadUserStats)(user.borrowed);
                  if (btnDetails.id === "booksReserved") (0, _userModel.loadUserStats)(user.reserved);
  ...
  return function getCurrentUserData(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.getCurrentUserData = getCurrentUserData;
},{"axios":"../../node_modules/axios/index.js","./models/userModel":"models/userModel.js"}],"models/bookModel.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.state = exports.showBookDetailsToAdmin = exports.loadFilteredBooks = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return exports; }; var exports = {}, Op = Object.prototype, hasOwn = Op.hasOwnProperty, defineProperty = Object.defineProperty || function (obj, key, desc) { obj[key] = desc.value; }, $Symbol = "function" == typeof Symbol ? Symbol : {}, iteratorSymbol = $Symbol.iterator || "@@iterator", asyncIteratorSymbol = $Symbol.asyncIterator || "@@asyncIterator", toStringTagSymbol = $Symbol.toStringTag || "@@toStringTag"; function define(obj, key, value) { return Object.defineProperty(obj, key, { value: value, enumerable: !0, configurable: !0, writable: !0 }), obj[key]; } try { define({}, ""); } catch (err) { define = function define(obj, key, value) { return obj[key] = value; }; } function wrap(innerFn, outerFn, self, tryLocsList) { var protoGenerator = outerFn && outerFn.prototype instanceof Generator ? outerFn : Generator, generator = Object.create(protoGenerator.prototype), context = new Context(tryLocsList || []); return defineProperty(generator, "_invoke", { value: makeInvokeMethod(innerFn, self, context) }), generator; } function tryCatch(fn, obj, arg) { try { return { type: "normal", arg: fn.call(obj, arg) }; } catch (err) { return { type: "throw", arg: err }; } } exports.wrap = wrap; var ContinueSentinel = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var IteratorPrototype = {}; define(IteratorPrototype, iteratorSymbol, function () { return this; }); var getProto = Object.getPrototypeOf, NativeIteratorPrototype = getProto && getProto(getProto(values([]))); NativeIteratorPrototype && NativeIteratorPrototype !== Op && hasOwn.call(NativeIteratorPrototype, iteratorSymbol) && (IteratorPrototype = NativeIteratorPrototype); var Gp = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(IteratorPrototype); function defineIteratorMethods(prototype) { ["next", "throw", "return"].forEach(function (method) { define(prototype, method, function (arg) { return this._invoke(method, arg); }); }); } function AsyncIterator(generator, PromiseImpl) { function invoke(method, arg, resolve, reject) { var record = tryCatch(generator[method], generator, arg); if ("throw" !== record.type) { var result = record.arg, value = result.value; return value && "object" == _typeof(value) && hasOwn.call(value, "__await") ? PromiseImpl.resolve(value.__await).then(function (value) { invoke("next", value, resolve, reject); }, function (err) { invoke("throw", err, resolve, reject); }) : PromiseImpl.resolve(value).then(function (unwrapped) { result.value = unwrapped, resolve(result); }, function (error) { return invoke("throw", error, resolve, reject); }); } reject(record.arg); } var previousPromise; defineProperty(this, "_invoke", { value: function value(method, arg) { function callInvokeWithMethodAndArg() { return new PromiseImpl(function (resolve, reject) { invoke(method, arg, resolve, reject); }); } return previousPromise = previousPromise ? previousPromise.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(innerFn, self, context) { var state = "suspendedStart"; return function (method, arg) { if ("executing" === state) throw new Error("Generator is already running"); if ("completed" === state) { if ("throw" === method) throw arg; return doneResult(); } for (context.method = method, context.arg = arg;;) { var delegate = context.delegate; if (delegate) { var delegateResult = maybeInvokeDelegate(delegate, context); if (delegateResult) { if (delegateResult === ContinueSentinel) continue; return delegateResult; } } if ("next" === context.method) context.sent = context._sent = context.arg;else if ("throw" === context.method) { if ("suspendedStart" === state) throw state = "completed", context.arg; context.dispatchException(context.arg); } else "return" === context.method && context.abrupt("return", context.arg); state = "executing"; var record = tryCatch(innerFn, self, context); if ("normal" === record.type) { if (state = context.done ? "completed" : "suspendedYield", record.arg === ContinueSentinel) continue; return { value: record.arg, done: context.done }; } "throw" === record.type && (state = "completed", context.method = "throw", context.arg = record.arg); } }; } function maybeInvokeDelegate(delegate, context) { var methodName = context.method, method = delegate.iterator[methodName]; if (undefined === method) return context.delegate = null, "throw" === methodName && delegate.iterator.return && (context.method = "return", context.arg = undefined, maybeInvokeDelegate(delegate, context), "throw" === context.method) || "return" !== methodName && (context.method = "throw", context.arg = new TypeError("The iterator does not provide a '" + methodName + "' method")), ContinueSentinel; var record = tryCatch(method, delegate.iterator, context.arg); if ("throw" === record.type) return context.method = "throw", context.arg = record.arg, context.delegate = null, ContinueSentinel; var info = record.arg; return info ? info.done ? (context[delegate.resultName] = info.value, context.next = delegate.nextLoc, "return" !== context.method && (context.method = "next", context.arg = undefined), context.delegate = null, ContinueSentinel) : info : (context.method = "throw", context.arg = new TypeError("iterator result is not an object"), context.delegate = null, ContinueSentinel); } function pushTryEntry(locs) { var entry = { tryLoc: locs[0] }; 1 in locs && (entry.catchLoc = locs[1]), 2 in locs && (entry.finallyLoc = locs[2], entry.afterLoc = locs[3]), this.tryEntries.push(entry); } function resetTryEntry(entry) { var record = entry.completion || {}; record.type = "normal", delete record.arg, entry.completion = record; } function Context(tryLocsList) { this.tryEntries = [{ tryLoc: "root" }], tryLocsList.forEach(pushTryEntry, this), this.reset(!0); } function values(iterable) { if (iterable) { var iteratorMethod = iterable[iteratorSymbol]; if (iteratorMethod) return iteratorMethod.call(iterable); if ("function" == typeof iterable.next) return iterable; if (!isNaN(iterable.length)) { var i = -1, next = function next() { for (; ++i < iterable.length;) if (hasOwn.call(iterable, i)) return next.value = iterable[i], next.done = !1, next; return next.value = undefined, next.done = !0, next; }; return next.next = next; } } return { next: doneResult }; } function doneResult() { return { value: undefined, done: !0 }; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, defineProperty(Gp, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), defineProperty(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, toStringTagSymbol, "GeneratorFunction"), exports.isGeneratorFunction = function (genFun) { var ctor = "function" == typeof genFun && genFun.constructor; return !!ctor && (ctor === GeneratorFunction || "GeneratorFunction" === (ctor.displayName || ctor.name)); }, exports.mark = function (genFun) { return Object.setPrototypeOf ? Object.setPrototypeOf(genFun, GeneratorFunctionPrototype) : (genFun.__proto__ = GeneratorFunctionPrototype, define(genFun, toStringTagSymbol, "GeneratorFunction")), genFun.prototype = Object.create(Gp), genFun; }, exports.awrap = function (arg) { return { __await: arg }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, asyncIteratorSymbol, function () { return this; }), exports.AsyncIterator = AsyncIterator, exports.async = function (innerFn, outerFn, self, tryLocsList, PromiseImpl) { void 0 === PromiseImpl && (PromiseImpl = Promise); var iter = new AsyncIterator(wrap(innerFn, outerFn, self, tryLocsList), PromiseImpl); return exports.isGeneratorFunction(outerFn) ? iter : iter.next().then(function (result) { return result.done ? result.value : iter.next(); }); }, defineIteratorMethods(Gp), define(Gp, toStringTagSymbol, "Generator"), define(Gp, iteratorSymbol, function () { return this; }), define(Gp, "toString", function () { return "[object Generator]"; }), exports.keys = function (val) { var object = Object(val), keys = []; for (var key in object) keys.push(key); return keys.reverse(), function next() { for (; keys.length;) { var key = keys.pop(); if (key in object) return next.value = key, next.done = !1, next; } return next.done = !0, next; }; }, exports.values = values, Context.prototype = { constructor: Context, reset: function reset(skipTempReset) { if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, this.tryEntries.forEach(resetTryEntry), !skipTempReset) for (var name in this) "t" === name.charAt(0) && hasOwn.call(this, name) && !isNaN(+name.slice(1)) && (this[name] = undefined); }, stop: function stop() { this.done = !0; var rootRecord = this.tryEntries[0].completion; if ("throw" === rootRecord.type) throw rootRecord.arg; return this.rval; }, dispatchException: function dispatchException(exception) { if (this.done) throw exception; var context = this; function handle(loc, caught) { return record.type = "throw", record.arg = exception, context.next = loc, caught && (context.method = "next", context.arg = undefined), !!caught; } for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i], record = entry.completion; if ("root" === entry.tryLoc) return handle("end"); if (entry.tryLoc <= this.prev) { var hasCatch = hasOwn.call(entry, "catchLoc"), hasFinally = hasOwn.call(entry, "finallyLoc"); if (hasCatch && hasFinally) { if (this.prev < entry.catchLoc) return handle(entry.catchLoc, !0); if (this.prev < entry.finallyLoc) return handle(entry.finallyLoc); } else if (hasCatch) { if (this.prev < entry.catchLoc) return handle(entry.catchLoc, !0); } else { if (!hasFinally) throw new Error("try statement without catch or finally"); if (this.prev < entry.finallyLoc) return handle(entry.finallyLoc); } } } }, abrupt: function abrupt(type, arg) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.tryLoc <= this.prev && hasOwn.call(entry, "finallyLoc") && this.prev < entry.finallyLoc) { var finallyEntry = entry; break; } } finallyEntry && ("break" === type || "continue" === type) && finallyEntry.tryLoc <= arg && arg <= finallyEntry.finallyLoc && (finallyEntry = null); var record = finallyEntry ? finallyEntry.completion : {}; return record.type = type, record.arg = arg, finallyEntry ? (this.method = "next", this.next = finallyEntry.finallyLoc, ContinueSentinel) : this.complete(record); }, complete: function complete(record, afterLoc) { if ("throw" === record.type) throw record.arg; return "break" === record.type || "continue" === record.type ? this.next = record.arg : "return" === record.type ? (this.rval = this.arg = record.arg, this.method = "return", this.next = "end") : "normal" === record.type && afterLoc && (this.next = afterLoc), ContinueSentinel; }, finish: function finish(finallyLoc) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.finallyLoc === finallyLoc) return this.complete(entry.completion, entry.afterLoc), resetTryEntry(entry), ContinueSentinel; } }, catch: function _catch(tryLoc) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.tryLoc === tryLoc) { var record = entry.completion; if ("throw" === record.type) { var thrown = record.arg; resetTryEntry(entry); } return thrown; } } throw new Error("illegal catch attempt"); }, delegateYield: function delegateYield(iterable, resultName, nextLoc) { return this.delegate = { iterator: values(iterable), resultName: resultName, nextLoc: nextLoc }, "next" === this.method && (this.arg = undefined), ContinueSentinel; } }, exports; }
...
exports.state = state;
var loadFilteredBooks = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          filter = _args.length > 0 && _args[0] !== undefined ? _args[0] : 'name';
          name = _args.length > 1 ? _args[1] : undefined;
          author = _args.length > 2 ? _args[2] : undefined;
          _context.prev = 3;
          _context.next = 6;
          return (0, _axios.default)({
            method: 'GET',
            url: "/api/v1/books/?sort=".concat(filter, "&fields=name,author,coverImage,slug&queries=").concat(name, ",").concat(author)
          });
        case 6:
          res = _context.sent;
          if (res.data.status === 'success') {
            ...
            books.map(function (book) {
              document.querySelector('.books').insertAdjacentHTML('beforeend', "\n        <a class=\"book\" id = \"".concat(book.id, "\" href=\"/").concat(book.slug, "\">\n            <img src=\"").concat(book.coverImage.startsWith('http') ? book.coverImage : '/img/books/' + book.coverImage, "\" alt=\"book\" class=\"img img__book-cover\">\n            <div class=\"book__cont\">\n                <h3 class=\"book__name\">").concat(book.name, "</h3>\n                <h4 class=\"book__author\">").concat(book.author, "</h4>\n            </div>\n            <button class=\"btn btn__primary btn__book-details\">detail</button>\n        </a>\n        "));
            });
          }
          _context.next = 13;
          break;
  ...
  return function loadFilteredBooks() {
    return _ref.apply(this, arguments);
  };
}();
exports.loadFilteredBooks = loadFilteredBooks;
var showBookDetailsToAdmin = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(book) {
    var res, _book, bookInfo, bookActions;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          ...
          return (0, _axios.default)({
            method: "GET",
            url: "/api/v1/books/".concat(book)
          });
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            _book = res.data.data.data;
            bookInfo = document.getElementById("book-info");
            bookActions = document.querySelector(".profile__stat--actions");
            bookInfo.textContent = "";
            bookInfo.insertAdjacentHTML("beforeend", "\n        <h4 class=\"admin__book-info admin__book-info--name\">N\xE1zov diela: <span>".concat(_book.name, "</span></h4>\n        <h4 class=\"admin__book-info admin__book-info--author\">Autor: <span>").concat(_book.author, "</span></h4>\n        <h4 class=\"admin__book-info admin__book-info--year\">Rok vydania: <span>").concat(new Date(_book.releaseDate).getFullYear(), "</span></h4>\n        <h4 class=\"admin__book-info admin__book-info--author\">ISBN: <span>").concat(_book.ISBN, "</span></h4>\n        <img src=\"").concat(_book.coverImage.startsWith('http') ? _book.coverImage : '/img/books/' + _book.coverImage, "\" alt=\"book\" class=\"img img__admin-book-info\">\n      "));
            bookActions.textContent = "";
            document.querySelector(".modal__inner").id = "".concat(_book.id);
            bookActions.insertAdjacentHTML("beforeend", "\n      <div class=\"admin__action-buttons\">\n        <h4 class=\"detail__h4\">Zmena \xFAdajov</h4>\n        <button class=\"btn btn__primary\" id=\"btn__edit-book\" data-id=\"".concat(_book.id, "\">Upravi\u0165</button>\n        <h4 class=\"detail__h4\">Odstr\xE1ni\u0165 knihu</h4>\n        <button class=\"btn btn__primary\" id=\"btn__delete-book\" data-id=\"").concat(_book.id, "\">Vymaza\u0165</button>\n      </div>\n      "));
          }
          _context2.next = 10;
          break;
        case 7:
  ...
  return function showBookDetailsToAdmin(_x) {
    return _ref2.apply(this, arguments);
  };
}();
exports.showBookDetailsToAdmin = showBookDetailsToAdmin;
},{"axios":"../../node_modules/axios/index.js"}],"updateUser.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') (0, _alerts.showAlert)('success', 'Profilová fotografia úspešne zmenená', 5);
          window.setTimeout(function () {
            location.assign('/profil');
          }, 500);
          _context.next = 11;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteBook.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(book) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          (0, _alerts.showAlert)('success', 'Kniha úspešne vymazaná z databázy', 5);
          window.setTimeout(function () {
            location.assign('/admin');
          }, 500);
          _context.next = 11;
...
var _headerLinksController = require("./headerLinksController");
var _authorisation = require("./authorisation");
var _searchBook = require("./searchBook");
var _createBook = require("./createBook");
var _getCurrentUserData = require("./getCurrentUserData");
var _bookModel = require("./models/bookModel");
var _userModel = require("./models/userModel");
var _helpers = require("./helpers");
var _updateUser = require("./updateUser");
var _deleteBook = require("./deleteBook");
(0, _headerLinksController.headerLinkController)();
(0, _getCurrentUserData.getCurrentUserData)();
var main = document.querySelector(".main");
var modal = document.querySelector('.modal');
var modalInner = document.querySelector('.modal__inner');
var btnCloseModal = document.querySelector(".btn__close-modal");
document.querySelector(".img__arma").addEventListener("click", function () {
  if (!document.querySelector(".img__people")) location.assign('/');
});

// SEARCHING BOOKS
if (document.getElementById('btn__search-book-data')) document.getElementById('btn__search-book-data').addEventListener('click', function (e) {
  e.preventDefault();
  (0, _helpers.resetSearchedData)();
  var authorInput = document.getElementById('author').value;
  var titleInput = document.getElementById('name').value;
  (0, _searchBook.searchBook)(authorInput, titleInput);
  document.getElementById('btn__search-book-data').textContent = 'Nové hľadanie';
});

// Manual search
if (document.getElementById('btn__manual-search')) {
  var manualSearchBtn = document.getElementById('btn__manual-search');
...
// UPLOADING IMAGE
if (document.getElementById('upload-cover-btn')) document.getElementById('upload-cover-btn').addEventListener('click', function (e) {
  e.preventDefault();
  (0, _helpers.openDialog)();
});

// ADDING NEW BOOK TO DATABASE
if (document.querySelector('.form__new-book')) {
  var newBookForm = document.querySelector('.form__new-book');
  newBookForm.addEventListener('submit', function (e) {
    ...
    form.append('coverImage', document.getElementById('uploadPhoto').files[0] ? document.getElementById('uploadPhoto').files[0] : document.querySelector('.img__book-preview').src);
    if (document.querySelector('.form__group--save-book').classList.contains('hidden')) return;
    (0, _createBook.createBook)(form);
  });
}
...
main.addEventListener("click", function (e) {
  if (e.target.closest("#btn__delete-book")) {
    var btnDelete = e.target.closest("#btn__delete-book");
...
modal.addEventListener("click", function (e) {
  if (e.target.closest("#btn__delete-book-confirm")) {
    (0, _deleteBook.deleteBook)(document.getElementById("btn__delete-book").dataset.id);
  }
});

// SORT BOOK DATABASE
if (document.querySelector(".sort")) {
  var sortCont = document.querySelector(".sort");
  sortCont.addEventListener("click", function (e) {
    if (e.target.closest(".btn__sort")) {
      var buttons = document.querySelectorAll(".btn__sort");
      var button = e.target.closest(".btn__sort");
      var author = document.getElementById("database-author").value;
      var name = document.getElementById("database-name").value;
      buttons.forEach(function (btn) {
        return btn.classList.remove("sort__active");
      });
      button.classList.add("sort__active");
      (0, _bookModel.loadFilteredBooks)(button.id, name, author);
    }
  });
}
...
if (document.getElementById("btn__load-database")) {
  var searchBTN = document.getElementById("btn__load-database");
  searchBTN.addEventListener("click", function (e) {
    e.preventDefault();
    var author = document.getElementById("database-author").value;
    var name = document.getElementById("database-name").value;
    var filter = document.querySelector(".sort__active").id;
    (0, _bookModel.loadFilteredBooks)(filter, name, author);
  });
}
...
if (document.querySelector('.btn__login--confirm')) document.querySelector('.btn__login--confirm').addEventListener("click", function (e) {
  e.preventDefault();
...
if (document.querySelector(".btn__change-password")) {
  document.querySelector(".btn__change-password").addEventListener("click", function (e) {
    e.preventDefault();
    var passwordCurrent = document.getElementById("change-password__old").value;
    var password = document.getElementById("change-password__new").value;
    var passwordConfirm = document.getElementById("change-password__confirm").value;
    console.log(passwordCurrent, password, passwordConfirm);
    (0, _authorisation.updatePassword)(passwordCurrent, password, passwordConfirm);
  });
}

// MAP
if (document.getElementById('map')) (0, _mapbox.displayMap)();

// PROFILE
if (document.querySelectorAll("btn__profile")) {
  var btnProfileStats = document.getElementById("btn-profile-stats");
  var btnProfileSettings = document.getElementById("btn-profile-settings");
  var profileStatsCont = document.querySelector(".profile__stats");
  var profileSettingsCont = document.querySelector(".profile__settings");
  var bookInfo = document.getElementById("book-info");
  var bookActions = document.getElementById("book-actions");
  if (btnProfileStats) btnProfileStats.addEventListener("click", function (e) {
    e.preventDefault();
    console.log("do ");
  ...
  if (btnProfileSettings) btnProfileSettings.addEventListener("click", function (e) {
    e.preventDefault();
...
if (document.getElementById("book-list")) {
  document.getElementById("book-list").addEventListener("click", function (e) {
    var book = e.target.closest(".admin__info--book").id;
    (0, _bookModel.showBookDetailsToAdmin)(book);
  });
}
